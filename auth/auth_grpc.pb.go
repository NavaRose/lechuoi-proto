...
type AuthClient interface {
	GetAuth(ctx context.Context, in *GetAuthInput, opts ...grpc.CallOption) (*GetAuthOutput, error)
}
...
func (c *authClient) GetAuth(ctx context.Context, in *GetAuthInput, opts ...grpc.CallOption) (*GetAuthOutput, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAuthOutput)
...
type AuthServer interface {
	GetAuth(context.Context, *GetAuthInput) (*GetAuthOutput, error)
...
func (UnimplementedAuthServer) GetAuth(context.Context, *GetAuthInput) (*GetAuthOutput, error) {
...
func _Auth_GetAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetAuth(ctx, req.(*GetAuthInput))
	}
